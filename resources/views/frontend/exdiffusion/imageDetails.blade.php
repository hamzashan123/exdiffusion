        ...
        <div class="col-md-6">
            ...
            <div class="dataOfImage p-3">
                ...
                <div class="images_publishBtns">
                    ...
                    <button id="btn_publishImage_imgDetail" class="btn btn-secondary text-light-grey-bg border-radius-7 relativeBtns" fdprocessedid="aq6tyu"> <img src="https://exdiffusion.com/newproject/public/img/icons/publish.png" class="btn_img">
                    ...
                    <button id="btn_generateImage_imgDetail" class="btn btn-secondary text-light-grey-bg border-radius-7 relativeBtns" fdprocessedid="s5h6ym"> <img src="https://exdiffusion.com/newproject/public/img/icons/generate-img.png" class="btn_img">
                        <div class="loaderbtn"></div> Generate Images
                    </button>

                    @if($data->is_super_resolution != 'true')
                    <button id="btn_superResolution_imgDetail" class="btn btn-secondary text-light-grey-bg border-radius-7 relativeBtns" fdprocessedid="s5h6ym"> <img src="https://exdiffusion.com/newproject/public/img/icons/makeSuperResolution.png" class="btn_img">
