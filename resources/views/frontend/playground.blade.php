            ...
            <div class="tab-pane fade show active text-white" id="txt2img" role="tabpanel" aria-labelledby="txt2img-tab">
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 relative">
                        <textarea name="" id="prompt" class="form-control dark-grey border-radius-7" rows="3" placeholder="Enter the Prompt here">white horse</textarea>
                        ...
                        <br>
                        <textarea name="" id="neg_prompt" class="form-control dark-grey border-radius-7" rows="3" placeholder="Enter the Negative Prompt here">not black</textarea>
