<div class="tab-pane fade show active text-white check" id="txt2img" role="tabpanel" aria-labelledby="txt2img-tab">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
            <button class="btn generate purple-col-bg form-control text-white border-radius-7 ajax-button relativeBtns" id="generateBtn">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12" id="generateImageDiv">
            <div class="images_result p-3">
                ...
                <div class="images_publishBtns">
                    <button id="make_publishimage" class="btn btn-secondary text-light-grey-bg border-radius-7 relativeBtns" disabled fdprocessedid="aq6tyu"><img src="https://exdiffusion.com/newproject/public/img/icons/publish.png" class="btn_img">
                        <div class="loaderbtn"></div> Publish the Image
                    </button>
                    <button id="make_creativehistory" disabled class="btn btn-secondary text-light-grey-bg border-radius-7 relativeBtns" fdprocessedid="s5h6ym"><img src="https://exdiffusion.com/newproject/public/img/icons/creative.png" class="btn_img">
                        <div class="loaderbtn"></div> Creative History
                    </button>
                    <button id="make_super_resolution" disabled class="btn btn-secondary text-light-grey-bg border-radius-7 relativeBtns" fdprocessedid="s5h6ym"><img src="https://exdiffusion.com/newproject/public/img/icons/makeSuperResolution.png" class="btn_img">
                        <div class="loaderbtn"></div> Make Super Resolution
                    </button>
                </div>
