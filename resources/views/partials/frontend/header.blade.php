<header class="header" style="display: none;">
  ...
  <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
    ...
    <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
      ...
      <li class="nav-item dropdown myowndropdown">
        <a class="nav-link dropdown-toggle text-light-grey" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          Welcome, {{ Auth::user()->first_name}}
        </a>
        <ul class="dropdown-menu">
          <li>
            <form action="{{ route('logout') }}" method="POST" class="nav-link px-3 text-light-grey ">
              @csrf
              <button type="submit" class="text-light-grey"> Logout</button>
            </form>
          </li>
